...
class CompositePreprocessor(Preprocessor):
    ...
    def get_data(self) -> pd.DataFrame:
        ...
        if self.config.dataset.simple:
            ...
            part_4 = data.loc[:, ['系列动作模仿正常 = 0', '系列动作模仿正常 = 1']]
            part_5 = data.loc[:, ['Rey回忆总分', 'Rey再认正确 = 0', 'Rey再认正确 = 1']]
